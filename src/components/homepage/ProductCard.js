...
function ProductCard({ image, title, description, price, cardHeight }) {
  return (
    <div
    ...
    >
      ...
      <div className="text-left flex-1 px-1">
        ...
        <p className="text-gray-600  leading-relaxed line-clamp-1">{description}</p>
      </div>
      ...
      <div className="flex justify-between items-center mt-2 border-t border-gray-200 pt-3">
        ...
        <button className="text-red-600 w-28 justify-center font-500 flex items-center hover:text-red-600 transition border p-2 border-red-600">
