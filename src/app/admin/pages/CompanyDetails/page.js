    ...
    async function fetchCompanyDetails() {
      ...
      try {
        ...
        if (data) {
          ...
          setHeaderImagePreview(data.headerImage ? `${process.env.NEXT_PUBLIC_UPLOADED_IMAGE_URL}/${data.headerImage}` : null);
          setFavIconPreview(data.favIcon ? `${process.env.NEXT_PUBLIC_UPLOADED_IMAGE_URL}/${data.favIcon}` : null);
        }
      } catch (error) {
